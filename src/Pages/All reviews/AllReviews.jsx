  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      >
        ...
        <button
          type="submit"
          className=" bg-gradient-to-r from-amber-500 to-orange-600 text-white hover:from-amber-600 hover:to-orange-700 cursor-pointer font-medium px-4 py-2 rounded"
        >
          Search
        </button>
      </form>
